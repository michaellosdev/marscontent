...
const navVariants = cva(
  "z-[998] flex w-full  items-center justify-center px-8 py-2 text-h2 lg:py-8  md:px-16 2xl:px-36",
  {
    variants: {
      fill: {
  ...
  (
    ...
    return (
      <div
        ...
        {...props}
      >
        <div className="z-[999] flex  h-24 items-center justify-start lg:flex-1 ">
          <Image
            src={logo}
            alt="logo"
