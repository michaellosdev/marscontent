...
const buttonVariants = cva("uppercase flex transition-all duration-100 ", {
  variants: {
    variant: {
      filled:
      ...
      "filled-extra":
        "bg-extra !text-white hover:opacity-75 disabled:opacity-25 active:opacity-50",
      outlined:
        "bg-transparent border-transparent   outline -outline-offset-2   border-white !text-white hover:bg-primary25 hover:border-primary50 disabled:border-primary25 disabled:!text-primary25 disabled:hover:bg-transparent active:bg-primary50 ",
      "outlined-secondary":
        "bg-transparent border-2 -outline-offset-4 border-secondary !text-secondary hover:bg-secondary hover:!text-primary hover:opacity-75  disabled:opacity-25 active:opacity-50 ",
      "outlined-accent":
        "bg-transparent border-2 -outline-offset-4 border-accent !text-accent hover:bg-accent hover:!text-primary hover:opacity-75  disabled:opacity-25 active:opacity-50 ",
      "outlined-extra":
        "bg-transparent border-2 -outline-offset-4 border-extra !text-extra hover:bg-extra hover:!text-primary hover:opacity-75  disabled:opacity-25 active:opacity-50 ",
